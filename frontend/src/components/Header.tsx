    ...
    <header className="sticky top-0 z-50 border-b border-gray-100 bg-white">
      <div className="mx-auto px-4 container">
          ...
          <div className="flex-1 md:flex md:items-center md:gap-12">
            <a href="/">
              <svg
                ...
                viewBox="0 0 239.24 239.24"
                className="h-10 w-10 text-teal-700"
                fill="currentColor"
              >
                <g>
                  <path
                    d="M228.965,131.859l-4.429-0.032c-4.024-0.028-9.105-3.01-11.092-6.511l-21.43-37.733c-2.639-4.647-8.893-8.288-14.237-8.288
		...
		l15.896,29.5C197.952,131.8,196.335,134.508,192.575,134.508z"
                  />
                  <path
                    d="M96.854,41.136h0.548c0.415,0,1.103-0.106,1.503-0.231c0.938-0.296,3.374-1.401,3.374-2.933
